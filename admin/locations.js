...
function appendPhoneInputField(val = "") {
  ...
  row.innerHTML = `
    <input type="text" class="form-control loc-phone-val" placeholder="e.g. +880 1311503840" value="${sanitizeHTML(val)}" style="flex: 1; padding: 8px 10px; border-radius: var(--radius-sm); border: 1px solid var(--border-color); font-size: 0.85rem;">
